...
function newFormatter(env, pretty, tabWidth) {
    ...
    return function format(diagnostic) {
        var categoryName = (_a = {},
            _a[DiagnosticCategory.Warning] = _gu.colors.yellow('warning'),
            _a[DiagnosticCategory.Error] = _gu.colors.red('error'),
            _a[DiagnosticCategory.Message] = _gu.colors.blue('message'),
            _a
        );
        var output = '';
        if (diagnostic.file) {
