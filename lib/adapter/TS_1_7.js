...
var TS_1_7_Adapter = (function () {
    ...
    TS_1_7_Adapter.prototype.compile = function (options, fileNames, cache) {
        ...
        for (var _i = 0, _a = program.getSourceFiles(); _i < _a.length; _i++) {
            ...
            var textFile = new textfile_1.TextFile(sourceFile.fileName, sourceFile.text);
    ...
    TS_1_7_Adapter.prototype.diagnostic = function (fileMap, tsd) {
        var cm = (_a = {},
        ...
        function diagnostic(tsd) {
            ...
            if (_.isString(what)) {
                return new diagnostic_1.Diagnostic(cm[tsd.category], tsd.code, what);
            }
            else {
                return new diagnostic_1.Diagnostic(cm[tsd.category], tsd.code, what.messageText, chain(what.next));
            }
        }
        function chain(tsc) {
            if (tsc) {
                return new diagnostic_1.DiagnosticChain(cm[tsc.category], tsc.code, tsc.messageText, chain(tsc.next));
            }
            else {
                return null;
            }
    ...
    TS_1_7_Adapter.VERSION = '~1.7.0-dev || ~1.7.0';
    return TS_1_7_Adapter;
})();
exports.TS_1_7_Adapter = TS_1_7_Adapter;
