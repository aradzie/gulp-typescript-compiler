...
var TS_1_8_Adapter = (function () {
    ...
    TS_1_8_Adapter.prototype.compileImpl = function (options, fileNames, cache) {
    ...
    TS_1_8_Adapter.prototype.mapDiagnostics = function (diagnostics) {
        var result = [];
        for (var _i = 0; _i < diagnostics.length; _i++) {
    ...
    TS_1_8_Adapter.prototype.mapDiagnostic = function (tsd) {
        var cm = (_a = {},
