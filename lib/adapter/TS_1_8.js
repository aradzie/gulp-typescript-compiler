...
var TS_1_8_Adapter = (function () {
    ...
    TS_1_8_Adapter.prototype.compile = function (options, fileNames, result) {
    ...
    TS_1_8_Adapter.prototype._compileImpl = function (options, fileNames, result) {
    ...
    TS_1_8_Adapter.prototype._reportDiagnostics = function (diagnostics, result) {
        for (var _i = 0; _i < diagnostics.length; _i++) {
            var tsd = diagnostics[_i];
            result.diagnostics.push(this._mapDiagnostic(tsd));
        }
    };
    TS_1_8_Adapter.prototype._mapDiagnostic = function (tsd) {
        var cm = (_a = {},
