...
var TS_1_6_Adapter = (function () {
    ...
    TS_1_6_Adapter.prototype.compileImpl = function (options, fileNames, cache) {
    ...
    TS_1_6_Adapter.prototype.mapDiagnostics = function (diagnostics) {
        var result = [];
        for (var _i = 0; _i < diagnostics.length; _i++) {
    ...
    TS_1_6_Adapter.prototype.mapDiagnostic = function (tsd) {
        var cm = (_a = {},
...
exports.default = TS_1_6_Adapter;
